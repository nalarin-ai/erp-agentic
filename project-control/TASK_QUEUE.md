...
| REC-001 | R-007, R-008 | FND-004, ADP-001 | reconciliation UI/worker/tests/runbook | READY | crash/restart/operator queue evidence |
...
| MIG-001 | R-005, R-008 | FND-001, ADP-001 | import/test paths | BACKLOG | hostile fixtures + dry-run/reconcile |

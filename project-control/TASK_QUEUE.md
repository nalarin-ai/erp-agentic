...
| ISO-001 | R-003, R-011, R-021 | EVAL-002, UNIT-001, CRM-001 | native security tests/evidence | DONE | all native surfaces + ADR |
| ISOFIX-001 | R-003, R-011, R-021 | ISO-001 | final isolation runtime/source/tests/evidence | DONE | implemented final architecture + fresh ISOLATION_FINAL=PASS |
...
| RPT-001 | R-001, R-011, R-021 | FND-002, FLOW-003 | owner report UI/service/tests | DONE | reconciled aggregation/no leakage |
...
| PILOT-001 | R-001..R-022 except R-010 post-MVP delivery | FLOW-001, FLOW-002, FLOW-003, CRM-001, UNIT-001, ISOFIX-001, UX-001, RPT-001, OPS-001, REC-001 | pilot E2E/evidence | READY | MVP-AC-01..15 |
